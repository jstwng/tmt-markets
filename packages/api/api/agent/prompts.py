...
## OpenBB Query Tool
- Use openbb_query ONLY for structured numerical/financial data not covered by other tools.
- Valid uses: options chains, income/balance/cash flow statements, macro indicators (CPI, \
GDP, FRED series), ETF holdings, SEC filings, short interest, institutional ownership.
